...
export const Signup = ({ setMainState }) => {
  ...
  return (
    ...
    <section className="flex login-top">
      ...
      <div>
        <label className="login-text" htmlFor="">name: </label>
        <input
      ...
      <div className="user-img-upload">
        <section className="flex">
          <label className="login-text" htmlFor="profilepic">Profilbild: </label>
          <input
      ...
      <button className="login-btn" onClick={() => fetchCreateUser()}>Skapa</button>
      </section>
    </>
  );
};
